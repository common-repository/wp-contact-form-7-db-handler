...
class expoert_ys_cfdbh_CSV{
    ...
    public function array2csv(array &$array, $df){
        ...
        if( $hide_columns = maybe_unserialize(get_post_meta( $form_post_id, 'show_form_columns', true ) ) ) {
        ...
        foreach ( $array['form_id'] as $line => $form_id ) { 
            ...
            foreach($array_keys as $array_key ) {
                $arrayk = str_replace('your-', '', $array_key);
                if( in_array($arrayk, $hide_columns) ) continue;
