              ...
              <div class="modal-content">
                ...
                <div class="modal-data">
                    ...
                    if( count($columnList) > 2 ) :
                        ...
                        $checkcon = false ;
                        if( $columns = get_post_meta( $this->form_post_id, 'show_form_columns', true ) ){
                            $columns = (isset($columns) ? unserialize($columns) : ''); 
                        ...
                        <div class="model-open-content">
                            ...
                            <form id="chnage-columns-names">
                                <table>
                                    <tr> 
                                        <th> <?php _e( 'Columns Name', 'contact-form-ys-cfdb7' ); ?> </th> 
                                        <th> <?php _e( 'New Name', 'contact-form-ys-cfdb7' ); ?> </th> 
                                    </tr>
                            ...
                            <div class="form-action-btns">
                                <button id="apply-show-column" class="button button-primary button-large form-btn-hide"> 
                                    <?php _e( 'Apply and show', 'contact-form-ys-cfdb7' ); ?> 
                                </button>
                                <button id="update-show-column" class="button button-primary button-large "> 
                                    <?php _e( 'Save Changes', 'contact-form-ys-cfdb7' ); ?>
                                </button>  
                            </div>    
